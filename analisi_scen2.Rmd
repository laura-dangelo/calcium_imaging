...
library(viridis)
require(gridExtra)
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/scen2_res_gMFM.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/scen2_res_DP.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/y_scen2.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/spp_scen2.Rdata")
n1 = 5000
n2 = 5000
n3 = 5000
n4 = 5000
...
```
Numero di clusters sulle osservazioni: 8 (7 spikes + assenza).

I gruppi totali sono 6 (J), e i dati sono simulati dalle distribuzioni 1, 2, 3, 1, 1, 2.
...
plot3 = ggplot(data = datAA_DP, aes(x = A)) + 
          ...
          theme_bw() +
          scale_x_continuous(breaks = c(0, 0.4, 0.6, 0.9, 1, 1.5) )
...
plot1 = ggplot(data = datAA_DP, aes(x = A)) + 
          ...
          stat_density(aes(y = ..density..), fill = 1, alpha = 0, col = 1) + 
          theme_bw() +
          scale_x_continuous(breaks = c(0.4, 0.75, 1, 1.15, 1.5, 1.75, 2) )
...
plot1 = ggplot(data = datAA_DP, aes(x = A)) + 
          ...
          stat_density(aes(y = ..density..), fill = 1, alpha = 0, col = 1) + 
          theme_bw() +
          scale_x_continuous(breaks = c(0, 0.5, 0.75, 1, 1.5, 1.75, 2) )
