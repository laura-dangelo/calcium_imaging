...
filename = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen4/Res/par", 
                  gammapar, "/scen1_run_gMFM_gammapar", gammapar, "_sim", nsim, ".Rdata")
load(file = filename)
...
for(nsim in 1:50)
{
  ...
  # filenameAA = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen4/Res/par",
  #                     gammapar, "/AAres_sim", nsim, ".Rdata")
  ...
  if(length(times) > 0)
  {
    ...
    number_clustersD[nsim] = as.numeric(attr(which.max(table(apply(run_gMFM$clusterD, 2, function(x) length(unique(x)) ))), "names"))
...
save(rand_indexO, file=paste0("scen4_par", gammapar, "_randindexO.Rdata") )
save(rand_indexD, file=paste0("scen4_par", gammapar, "_randindexD.Rdata") )
...
save(false_negatives, file=paste0("scen4_par", gammapar, "_false_neg.Rdata")  )
save(false_positives, file=paste0("scen4_par", gammapar, "_false_pos.Rdata"))
save(number_clustersD, file=paste0("scen4_par", gammapar, "_nclusD.Rdata"))
save(number_clustersO, file=paste0("scen4_par", gammapar, "_nclusO.Rdata"))
save(number_clustersO_j, file=paste0("scen4_par", gammapar, "_nclusOj.Rdata"))
...
for(nsim in 1:10)
{
  filename = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen", 3,"/Res/par", 
                    gammapar, "/scen", 3, "_run_gMFM_gammapar", gammapar, "_sim", nsim, ".Rdata")
  load(file = filename)
