...
clus = kmeans(diff(y,1)[(diff(y,1))>0.3], centers = 7)
A_start = rep(0,50)
A_start[2:8] = c(clus$centers)
...
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen4/data/A_start_scen1.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen4/data/cluster_scen1.Rdata")
