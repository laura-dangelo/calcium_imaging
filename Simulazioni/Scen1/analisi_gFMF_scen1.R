...
load("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen1/data/A_scen1.Rdata")
...
for(nsim in 1:50)
{
  ...
  # }
  filenameAA = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni/Scen", 1,"/Res/par",
  ...
  # subsetAA = AA_gMFM[,int]
  # number_clustersO_j[nsim,6] = as.numeric(attr(which.max(table( apply(subsetAA, 1, function(x) length(unique(x))) )), "names"))
  # 
