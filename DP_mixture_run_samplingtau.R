...
sourceCpp('calcium_DP_mixture_samplingtauNO.cpp')
...
# capire perchè non accetta valore 0 per tau2
# sampling della varianza pp 167-168
#
...
run = calcium_gibbs(Nrep = nrep, y = y, 
                      ...
                      hyp_b1 = 0, hyp_b2 = 1, 
                      hyp_lambda1 = 1000, hyp_lambda2 = 1, 
                      hyp_tau1 = 0.001, hyp_tau2 = 100, 
...
plot(1:length(run$tau), run$tau, type = "l", xlab = "iterazioni", ylab = "tau")
