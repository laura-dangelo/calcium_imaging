...
for(nsim in 1:50)
{
  ...
  fit <- FastLZeroSpikeInference::estimate_spikes(dat = y, gam = 0.7, lambda = lambda)
...
save(false_negatives, file=paste0("L0_2_false_neg2.Rdata") )
save(false_positives, file=paste0("L0_2_false_pos2.Rdata") )

save(FN, file=paste0("L0_2_FN.Rdata") )
save(FP, file=paste0("L0_2_FP.Rdata") )
save(TN, file=paste0("L0_2_TN.Rdata") )
save(TP, file=paste0("L0_2_TP.Rdata") )
