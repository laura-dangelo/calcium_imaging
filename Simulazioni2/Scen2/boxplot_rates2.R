...
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/L0_1_false_pos2.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/L0_1_false_neg2.Rdata")
...
p2 = ggplot(data_scen2, aes(x = model, y = value, fill = model)) + 
  geom_boxplot() +
...
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/par8/scen2_par8_FN.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/par8/scen2_par8_FP.Rdata")

rate_gMFM = (FP+FN)/20000


load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/DP_par8/scen2DP_par8_FN.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/DP_par8/scen2DP_par8_FP.Rdata")

rate_DP = (FP+FN)/20000

load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/L0_2_FP.Rdata")
load("/home/laura/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen2/L0_2_FN.Rdata")

rate_L0 = (FP+FN)/20000

data_scen2 <- data.frame("value" = c( false_positives_gMFM, false_negatives_gMFM, rate_gMFM,
...
p21 = ggplot(data_scen2, aes(x = model, y = value, fill = rate)) + 
  geom_boxplot() +
  facet_wrap(~ rate, scales = "free") +
  xlab("") +
  ylab("Scenario 1") +
