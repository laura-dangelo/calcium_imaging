...
for(nsim in 1:50)
{
  ...
  FP[nsim] = false_positives[nsim] * (n-length(spp))
  TN[nsim] = (n-length(spp)) - FP[nsim]
  TP[nsim] = length(spp) - FN[nsim]
}


save(false_negatives, file=paste0("L0_3_false_neg2.Rdata") )
save(false_positives, file=paste0("L0_3_false_pos2.Rdata") )

save(FN, file=paste0("L0_3_FN.Rdata") )
save(FP, file=paste0("L0_3_FP.Rdata") )
save(TN, file=paste0("L0_3_TN.Rdata") )
save(TP, file=paste0("L0_3_TP.Rdata") )
