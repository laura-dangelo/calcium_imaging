...
gammapar = 8
nsim = 1
filename = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen3/DP_par", 
                  gammapar, "/scen3_run_DP_gammapar", gammapar, "_sim", nsim, ".Rdata")
load(file = filename)
filename = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen3/data/data_scen3_seed", 
                  nsim, ".Rdata")
load(file = filename)
...
for(nsim in 2:50)
{
  ...
  filenameAA = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen3/DP_par",
  ...
  if(length(times)>0)
  {
    ...
    rand_indexD[nsim,] = apply(run_DP$clusterD[,-burnin], 2, function(x) adjustedRandIndex(x, c(1,2,3,1,2) ) )
...
save(FN, file=paste0("scen3DP_par", gammapar, "_FN.Rdata") )
save(FP, file=paste0("scen3DP_par", gammapar, "_FP.Rdata") )
save(TN, file=paste0("scen3DP_par", gammapar, "_TN.Rdata") )
save(TP, file=paste0("scen3DP_par", gammapar, "_TP.Rdata") )



save(rand_indexO, file=paste0("scen3DP_par", gammapar, "_randindexO.Rdata") )
save(rand_indexD, file=paste0("scen3DP_par", gammapar, "_randindexD.Rdata") )
...
save(false_negatives, file=paste0("scen3DP_par", gammapar, "_false_neg.Rdata") )
save(false_positives, file=paste0("scen3DP_par", gammapar, "_false_pos.Rdata") )
# save(number_clustersD, file=paste0("scen3_par", gammapar, "_nclusD.Rdata") )
# save(number_clustersO, file=paste0("scen3_par", gammapar, "_nclusO.Rdata") )
# save(number_clustersO_j, file=paste0("scen3_par", gammapar, "_nclusOj.Rdata") )
