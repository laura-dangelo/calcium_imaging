...
gammapar = 8
nsim = 3
filename = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen1/par", 
...
for(nsim in 50)
{
  ...
  if(length(times)>0)
  {
    filenameAA = paste0("~/Documents/Dottorato/2.06 Calcium imaging/calcium_imaging/calcium_imaging/Simulazioni2/Scen1/par",
...
save(FN, file=paste0("scen1_par", gammapar, "_FN.Rdata") )
save(FP, file=paste0("scen1_par", gammapar, "_FP.Rdata") )
save(TN, file=paste0("scen1_par", gammapar, "_TN.Rdata") )
save(TP, file=paste0("scen1_par", gammapar, "_TP.Rdata") )
